...
- [x] Stabilize full-suite Supabase integration-test timeout configuration after the expanding source-backed flashcard corpus caused transient 5-second test timeouts; the full suite passes with the explicit 15-second integration timeout.

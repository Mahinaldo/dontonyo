...
export default function Progress() {
  ...
  const summary=getProgressSummary({content:overview.data?.content??[],attempts:overview.data?.attempts??[],daily:overview.data?.daily??[]}); const {completed,answered,accuracy,days}=summary;

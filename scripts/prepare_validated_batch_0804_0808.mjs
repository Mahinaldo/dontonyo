...
const work = "/home/ubuntu/dontonyo-work/batch-0804-0808";
const out = path.join(root, "supabase", "batch-0804-0808");
const quote = (value) => `'${String(value ?? "").replaceAll("'", "''")}'`;
const json = (value) => `${quote(JSON.stringify(value))}::jsonb`;
const hash = (value) => createHash("sha256").update(value).digest("hex");

export const BATCH_PAGES = [804, 805, 806, 807, 808];
export const PIPELINE_VERSION = "local-ocr-quality-gated-batch-0804-0808-v1";
...
export async function buildBatch() {
  ...
  const audit = {
    ...
    source_anomalies: [
      ...
      "Quotation-attribution, political, legal, ideological, religious, military, geographic, territorial, national, and location-linked claims were withheld."
    ],
    quality_gates: [
      "Only source pages 804–808 are included.",
  ...
  const pageSql = pages.map((page) => {
    ...
    const metadata = {
      ...
      review_report: `${out}/visual_review_804_808.md`,
  ...
  const sql = `-- Generated by prepare_validated_batch_0804_0808.mjs. Source pages 804–808 only.
BEGIN;

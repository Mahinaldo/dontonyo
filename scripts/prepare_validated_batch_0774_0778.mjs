...
const work = "/home/ubuntu/dontonyo-work/batch-0774-0778";
const out = path.join(root, "supabase", "batch-0774-0778");
const quote = (value) => `'${String(value ?? "").replaceAll("'", "''")}'`;
const json = (value) => `${quote(JSON.stringify(value))}::jsonb`;
const hash = (value) => createHash("sha256").update(value).digest("hex");

export const BATCH_PAGES = [774, 775, 776, 777, 778];
export const PIPELINE_VERSION = "local-ocr-quality-gated-batch-0774-0778-v1";
...
export async function buildBatch() {
  ...
  const audit = {
    ...
    source_anomalies: [
      ...
      "Institutional, political, diplomatic, military, economic, treaty, membership, financial, leadership, ranking, location, date, policy, intelligence, conflict, and current-status claims were withheld.",
    ],
    quality_gates: [
      "Only source pages 774–778 are included.",
  ...
  const pageSql = pages
    .map((page) => {
      ...
      const metadata = {
        ...
        review_status: "completed_image_grounded_review",
        review_report: `${out}/visual_review_774_778.md`,
  ...
  const sql = `-- Generated by prepare_validated_batch_0774_0778.mjs. Source pages 774–778 only.
BEGIN;

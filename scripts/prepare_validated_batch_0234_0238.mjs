...
const work = "/home/ubuntu/dontonyo-work/batch-0234-0238";
const out = path.join(root, "supabase", "batch-0234-0238");
const quote = value => `'${String(value ?? "").replaceAll("'", "''")}'`;
const json = value => `${quote(JSON.stringify(value))}::jsonb`;
const hash = value => createHash("sha256").update(value).digest("hex");

export const BATCH_PAGES = [234, 235, 236, 237, 238];
export const PIPELINE_VERSION = "local-ocr-quality-gated-recovery-batch-0234-0238-v1";
...
export async function buildBatch() {
  ...
  const audit = {
    ...
    source_anomalies: [
      ...
      "OCR degradation and visually uncertain spellings were preserved without silent correction.",
      "Political, military/security, diplomatic, international-relations, national, historical, cultural/literary-attribution, media, governmental, institutional, legal, atrocity/death, recognition, charitable, numerical, named-person, and date-sensitive claims were withheld."
    ],
    quality_gates: [
      "Only recovery source pages 234–238 are included.",
  ...
  const tags = [
    ...
    ["international-relations-reference", "International relations reference", "domain", "International-relations material retained as reviewed source provenance."],
    ["cultural-history-reference", "Cultural history reference", "domain", "Cultural-history material retained as reviewed source provenance."],

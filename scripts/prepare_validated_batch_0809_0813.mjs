...
const work = "/home/ubuntu/dontonyo-work/batch-0809-0813";
const out = path.join(root, "supabase", "batch-0809-0813");
const quote = (value) => `'${String(value ?? "").replaceAll("'", "''")}'`;
const json = (value) => `${quote(JSON.stringify(value))}::jsonb`;
const hash = (value) => createHash("sha256").update(value).digest("hex");

export const BATCH_PAGES = [809, 810, 811, 812, 813];
export const PIPELINE_VERSION = "local-ocr-quality-gated-batch-0809-0813-v1";
...
export async function buildBatch() {
  ...
  const audit = {
    ...
    source_anomalies: [
      ...
      "Geographic, territorial, national, location-linked, border, ranking/superlative, and source-imprecise claims were withheld."
    ],
    quality_gates: [
      "Only source pages 809–813 are included.",
  ...
  const pageSql = pages.map((page) => {
    ...
    const metadata = {
      ...
      review_report: `${out}/visual_review_809_813.md`,
  ...
  const sql = `-- Generated by prepare_validated_batch_0809_0813.mjs. Source pages 809–813 only.
BEGIN;

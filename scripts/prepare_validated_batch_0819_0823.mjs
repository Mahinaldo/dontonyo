...
const work = "/home/ubuntu/dontonyo-work/batch-0819-0823";
const out = path.join(root, "supabase", "batch-0819-0823");
const quote = (value) => `'${String(value ?? "").replaceAll("'", "''")}'`;
const json = (value) => `${quote(JSON.stringify(value))}::jsonb`;
const hash = (value) => createHash("sha256").update(value).digest("hex");

export const BATCH_PAGES = [819, 820, 821, 822, 823];
export const PIPELINE_VERSION = "local-ocr-quality-gated-batch-0819-0823-v1";
...
export async function buildBatch() {
  ...
  const audit = {
    ...
    quality_gates: [
      "Only source pages 819–823 are included.",
  ...
  const pageSql = pages.map((page) => {
    ...
    const metadata = {
      ...
      review_report: `${out}/visual_review_819_823.md`,
  ...
  const sql = `-- Generated by prepare_validated_batch_0819_0823.mjs. Source pages 819–823 only.
BEGIN;

...
const work = "/home/ubuntu/dontonyo-work/batch-0824-0828";
const out = path.join(root, "supabase", "batch-0824-0828");
const quote = (value) => `'${String(value ?? "").replaceAll("'", "''")}'`;
const json = (value) => `${quote(JSON.stringify(value))}::jsonb`;
const hash = (value) => createHash("sha256").update(value).digest("hex");

export const BATCH_PAGES = [824, 825, 826, 827, 828];
export const PIPELINE_VERSION = "local-ocr-quality-gated-batch-0824-0828-v1";
...
export async function buildBatch() {
  ...
  const audit = {
    ...
    quality_gates: [
      "Only source pages 824–828 are included.",
  ...
  const pageSql = pages.map((page) => {
    ...
    const metadata = {
      ...
      review_report: `${out}/visual_review_824_828.md`,
  ...
  const sql = `-- Generated by prepare_validated_batch_0824_0828.mjs. Source pages 824–828 only.
BEGIN;

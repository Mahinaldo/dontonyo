...
const work = "/home/ubuntu/dontonyo-work/batch-0884-0888";
const out = path.join(root, "supabase", "batch-0884-0888");
const quote = value => `'${String(value ?? "").replaceAll("'", "''")}'`;
const json = value => `${quote(JSON.stringify(value))}::jsonb`;
const hash = value => createHash("sha256").update(value).digest("hex");

export const BATCH_PAGES = [884, 885, 886, 887, 888];
export const PIPELINE_VERSION = "local-ocr-quality-gated-batch-0884-0888-v1";
...
export async function buildBatch() {
  ...
  const audit = {
    ...
    quality_gates: [
      "Only source pages 884–888 are included.",

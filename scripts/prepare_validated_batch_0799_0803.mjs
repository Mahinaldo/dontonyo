...
const work = "/home/ubuntu/dontonyo-work/batch-0799-0803";
const out = path.join(root, "supabase", "batch-0799-0803");
...
export const BATCH_PAGES = [799, 800, 801, 802, 803];
export const PIPELINE_VERSION = "local-ocr-quality-gated-batch-0799-0803-v1";
...
export async function buildBatch() {
  ...
  const audit = {
    ...
    source_anomalies: [
      ...
      "Political, military, leadership, economic, ideological, legal, religiously adjacent, translation, ISBN, quotation-attribution, duplicate, and source-imprecise claims were withheld."
    ],
    quality_gates: [
      "Only source pages 799–803 are included.",
  ...
  const pageSql = pages.map((page) => {
    ...
    const metadata = {
      ...
      review_report: `${out}/visual_review_799_803.md`,

...
const work = "/home/ubuntu/dontonyo-work/batch-0829-0833";
const out = path.join(root, "supabase", "batch-0829-0833");
const quote = (value) => `'${String(value ?? "").replaceAll("'", "''")}'`;
const json = (value) => `${quote(JSON.stringify(value))}::jsonb`;
const hash = (value) => createHash("sha256").update(value).digest("hex");

export const BATCH_PAGES = [829, 830, 831, 832, 833];
export const PIPELINE_VERSION = "local-ocr-quality-gated-batch-0829-0833-v1";
...
export async function buildBatch() {
  ...
  const audit = {
    ...
    source_anomalies: [
      ...
      "Geographic, territorial, political, religious, border, current-status, location-linked, ranking/superlative, seasonal-date, and source-imprecise claims were withheld."
    ],
    quality_gates: [
      "Only source pages 829–833 are included.",
      ...
      "Only reviewed source-page provenance and page-local topic boundaries are admitted."
    ]
  };
  ...
  const pageSql = pages.map((page) => {
    ...
    const metadata = {
      ...
      review_report: `${out}/visual_review_829_833.md`,
  ...
  const sql = `-- Generated by prepare_validated_batch_0829_0833.mjs. Source pages 829–833 only.
BEGIN;

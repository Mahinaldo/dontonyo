# Bounded Integrity Report — Jubayer’s GK Recovery Physical Pages 259–263

The idempotent recovery import transaction was executed against Supabase project `rennotctgrxvbpghbimx`. The bounded audit queried **only** physical source pages 259–263 and their five exact page-local provenance-topic slugs. The MCQ-option count is bounded through `public.gk_mcq_options o` joined to `public.gk_mcqs m ON m.id=o.mcq_id`.
...
The observed counts match the provenance-only classification. No learner-facing or verification records were inserted from political, national, constitutional, diplomatic, military/security, government, historical, cultural, recognition, gender-related, refugee/minority, legal, memorial/death, named-person, or date-sensitive material.
